...
class NavTest():
    def __init__(self):
        ...
        locations.append(Pose(Point(-1.3, 16, 0.000), Quaternion(0.000, 0.000, 0.704, 0.71)))
        locations.append(Pose(Point(1.3, 21, 0.000), Quaternion(0.000, 0.000, 0.704, 0.71)))
        locations.append(Pose(Point(2.5, 28, 0.000), Quaternion(0.000, 0.000, 0.704, 0.71)))
        locations.append(Pose(Point(1, 39, 0.000), Quaternion(0.000, 0.000, 0.704, 0.71)))
