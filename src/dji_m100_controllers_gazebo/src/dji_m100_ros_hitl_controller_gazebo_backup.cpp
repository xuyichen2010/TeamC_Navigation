    ...
    class DJI_ROS_ControlPlugin : public ModelPlugin{
        public:
            ...
            void gpsCallback(const sensor_msgs::NavSatFix::ConstPtr& gps_msg)
            {
                ...
                math::Vector3 local_position = this->spherical_coordinates_handle->LocalFromSpherical(ignition::math::Vector3d(lat,lon,alt));
            ...
            void OnUpdate(){
                ...
                #else
                    math::Pose gimbal_pose = this->gimbal_yaw_link->GetRelativePose();
                    gimbal_pose.Set(gimbal_pose.pos,this->gimbal_orientation);
                #endif
        ...
        private:
            ...
            event::ConnectionPtr update_connection;
                ...
                math::Vector3 gimbal_orientation;
